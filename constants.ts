import { LabTest, Gender, SampleType } from './types';
...
export const AVAILABLE_TESTS: LabTest[] = [
  ...
  },
  {
    ...
    price: 1100,
    sampleTypeId: 'edta',
    parameters: [{ id: 'hba1c_val', name: 'HbA1c Level', unit: '%', referenceRange: '< 5.7' }]
  },
  {
    id: 'urine_rm',
    name: 'Urine R/M',
  ...
  },
  {
    ...
    price: 3500,
    sampleTypeId: 'serum',
    parameters: [{ id: 'vit_d_val', name: 'Vitamin D Total', unit: 'ng/mL', referenceRange: '30 - 100' }]
  },
  {
    id: 'vit_b12',
    name: 'Vitamin B12',
    ...
    price: 2800,
    sampleTypeId: 'serum',
    parameters: [{ id: 'b12_val', name: 'Vitamin B12', unit: 'pg/mL', referenceRange: '200 - 900' }]
  }
];

export const MOCK_PATIENTS = [
  { id: 'P001', name: 'John Doe', age: 34, gender: Gender.MALE, phone: '0300-1234567' },
  { id: 'P002', name: 'Jane Smith', age: 29, gender: Gender.FEMALE, phone: '0333-9876543' },
  { id: 'P003', name: 'Robert Brown', age: 55, gender: Gender.MALE, phone: '0345-1122334' },
];